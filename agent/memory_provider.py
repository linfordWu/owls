...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - owls_home (str): The active OWLS_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.owls``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "owls").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'owls memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], owls_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'owls memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``owls_home`` is the active OWLS_HOME directory path.
