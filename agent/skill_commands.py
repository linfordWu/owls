...
def build_plan_path(
    ...
    *,
    ...
    workspace instead of the OWLS host's global home directory.
    """
    ...
    return Path(".owls") / "plans" / f"{timestamp}-{slug}.md"
...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    If the loaded skill's frontmatter declares ``metadata.owls.config``
    ...
    try:
        ...
        lines = ["", f"[Skill config (from {display_owls_home()}/config.yaml):"]
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    """Scan ~/.owls/skills/ and return a mapping of /command -> skill info.
