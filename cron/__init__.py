"""
Cron job scheduling system for OWLS.
...
Cron jobs are executed automatically by the gateway daemon:
    owls gateway install    # Install as a user service
    sudo owls gateway install --system  # Linux servers: boot-time system service
    owls gateway            # Or run in foreground
