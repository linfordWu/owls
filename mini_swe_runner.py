#!/usr/bin/env python3
"""
SWE Runner with OWLS Trajectory Format

A runner that uses OWLS's built-in execution environments
(local, docker, modal) and outputs trajectories in the OWLS format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses OWLS's Docker, Modal, or Local environments for command execution
- Outputs trajectories in OWLS format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches OWLS format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using OWLS's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with OWLS Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses OWLS's built-in execution environments
    and outputs trajectories in OWLS format.
    """
    ...
    def _convert_to_owls_format(
        ...
        """
        Convert internal message format to OWLS trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to OWLS trajectory format
        trajectory = self._convert_to_owls_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with OWLS trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with OWLS Trajectory Format")
    print("=" * 60)
