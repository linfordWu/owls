...
import { saveCredentials as saveCredsApi, fetchWeixinQrCode, pollWeixinQrStatus, saveWeixinCredentials } from '@/api/owls/config'
...
// Save credentials to .env (matching owls gateway setup behavior)
...
const platforms = allPlatforms.filter(p => p.key === 'feishu' || p.key === 'weixin')
</script>
