export default {
  ...
  sidebar: {
    ...
    updateTip: 'Fuhren Sie "owls-web-ui update" im Terminal aus, um zu aktualisieren',
  ...
  chat: {
    ...
    emptyState: 'Starten Sie eine Konversation mit OWLS Agent',
  ...
  platform: {
    ...
    weixinTokenHint: 'Von Weixin-CLI QR-Anmeldung (owls weixin)',
    accountId: 'Konto-ID',
