export default {
  ...
  login: {
    ...
    forceSetupDescription: 'Token verified for first-time access. Set a login password now; future logins will use the password.',
    users: 'Users',
  ...
  sidebar: {
    ...
    expand: 'Expand menu',
    updateTip: 'Run "owls-web-ui update" in terminal to update',
  ...
  chat: {
    ...
    emptyState: 'Start a conversation with OWLS Agent',
    inputPlaceholder: 'Type a message... (Enter to send, Shift+Enter for new line)',
    attachFiles: 'Attach files',
    voiceInput: 'Voice input',
    voiceListening: 'Listening...',
    voiceRecording: 'Recording. Click the microphone again to stop and transcribe.',
    voiceStopRecording: 'Stop recording and transcribe',
    voiceTranscribing: 'Transcribing speech...',
    voiceUnsupported: 'Voice input is not supported by this browser. Use Chrome or Edge.',
    voiceNoSpeech: 'No speech detected. Move closer to the microphone and try again.',
    voiceNoMatch: 'No recognizable speech was found. Please try again.',
    voiceNetworkError: 'Speech recognition network service is unavailable. Check your network or browser speech service.',
    voiceNetworkFallback: 'Browser speech network service is unavailable. Local recording transcription is active; click the microphone again to finish.',
    voicePermissionDenied: 'Microphone permission was denied. Allow microphone access in the browser address bar.',
    voiceAudioCaptureError: 'No usable microphone was detected. Check your system input device.',
    voiceLanguageUnsupported: 'This browser does not support the selected recognition language.',
    voiceStartFailed: 'Failed to start speech recognition. Refresh the page and try again.',
    voiceTranscribeFailed: 'Local speech transcription failed',
    stop: 'Stop',
    start: 'Start',
  ...
  skills: {
    ...
    import: 'Import Skill',
    importSuccess: 'Imported {name} ({count} file(s))',
    importFailed: 'Failed to import skill',
    delete: 'Delete skill',
    deleteConfirm: 'Delete skill "{name}"? This will remove its local files.',
  ...
  platform: {
    ...
    weixinTokenHint: 'From weixin CLI QR login (owls weixin)',
