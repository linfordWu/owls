export default {
  ...
  sidebar: {
    ...
    updateTip: 'Ejecuta "owls-web-ui update" en la terminal para actualizar',
  ...
  chat: {
    ...
    emptyState: 'Inicia una conversacion con OWLS Agent',
  ...
  platform: {
    ...
    weixinTokenHint: 'Desde el inicio de sesion QR de la CLI de weixin (owls weixin)',
