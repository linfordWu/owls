export default {
  ...
  sidebar: {
    ...
    updateTip: 'Executez "owls-web-ui update" dans le terminal pour mettre a jour',
  ...
  chat: {
    ...
    emptyState: 'Demarrer une conversation avec OWLS Agent',
  ...
  platform: {
    ...
    weixinTokenHint: 'Depuis la connexion QR de la CLI weixin (owls weixin)',
