export default {
  ...
  sidebar: {
    ...
    updateTip: 'Execute "owls-web-ui update" no terminal para atualizar',
  ...
  chat: {
    ...
    emptyState: 'Inicie uma conversa com o OWLS Agent',
  ...
  platform: {
    ...
    weixinTokenHint: 'Do login QR da CLI weixin (owls weixin)',
