export default {
  ...
  login: {
    ...
    forceSetupDescription: '首次令牌验证成功。请立即设置登录密码，之后将直接使用密码登录。',
    users: '用户',
    createUser: '创建普通用户',
    userCreated: '用户已创建',
    adminRole: '管理员',
  ...
  sidebar: {
    ...
    collapse: '收起菜单',
    expand: '展开菜单',
    updateTip: '在终端运行 "owls-web-ui update" 即可更新',
  ...
  chat: {
    contextRemaining: '剩余',
    emptyState: '开始与 OWLS Agent 对话',
    inputPlaceholder: '输入消息... (Enter 发送，Shift+Enter 换行)',
    attachFiles: '添加附件',
    voiceInput: '语音输入',
    voiceListening: '正在听写...',
    voiceRecording: '正在录音，再次点击麦克风结束并转写',
    voiceStopRecording: '结束录音并转写',
    voiceTranscribing: '正在转写语音...',
    voiceUnsupported: '当前浏览器不支持语音输入，请使用 Chrome 或 Edge',
    voiceNoSpeech: '没有检测到语音，请靠近麦克风后再试',
    voiceNoMatch: '没有识别到可用文字，请再说一次',
    voiceNetworkError: '语音识别网络服务不可用，请检查网络或浏览器语音服务',
    voiceNetworkFallback: '浏览器语音网络服务不可用，已切换为本地录音转写；请再次点击麦克风结束录音',
    voicePermissionDenied: '麦克风权限被拒绝，请在浏览器地址栏允许麦克风权限',
    voiceAudioCaptureError: '没有检测到可用麦克风，请检查系统输入设备',
    voiceLanguageUnsupported: '当前浏览器不支持该识别语言',
    voiceStartFailed: '语音识别启动失败，请刷新页面后重试',
    voiceTranscribeFailed: '本地语音转写失败',
    stop: '停止',
    start: '启动',
    stopGateway: '停止网关',
    send: '发送',
  ...
  skills: {
    ...
    import: '导入技能',
    importSuccess: '已导入技能 {name}（{count} 个文件）',
    importFailed: '导入技能失败',
    delete: '删除技能',
    deleteConfirm: '确定删除技能 "{name}" 吗？这会移除本地技能文件。',
    deleteSuccess: '技能已删除',
    deleteFailed: '删除技能失败',
  },
  ...
  platform: {
    ...
    weixinTokenHint: '通过 weixin CLI 扫码登录获取 (owls weixin)',
