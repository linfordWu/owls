...
import { useFilesStore } from '@/stores/owls/files'
import FileTree from '@/components/owls/files/FileTree.vue'
import FileBreadcrumb from '@/components/owls/files/FileBreadcrumb.vue'
import FileToolbar from '@/components/owls/files/FileToolbar.vue'
import FileList from '@/components/owls/files/FileList.vue'
import FileContextMenu from '@/components/owls/files/FileContextMenu.vue'
import FileEditor from '@/components/owls/files/FileEditor.vue'
import FilePreview from '@/components/owls/files/FilePreview.vue'
import FileUploadModal from '@/components/owls/files/FileUploadModal.vue'
import FileRenameModal from '@/components/owls/files/FileRenameModal.vue'
import type { FileEntry } from '@/api/owls/files'
