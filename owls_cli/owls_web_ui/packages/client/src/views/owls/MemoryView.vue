...
import { fetchMemory, saveMemory, type MemoryData } from '@/api/owls/skills'
...
const canEditMemory = computed(() => appStore.currentUserRole === 'admin')
</script>
      ...
      <div v-else class="memory-sections">
          ...
          <div class="memory-section">
            <div class="section-header">
              ...
              <NButton v-if="canEditMemory && editingSection !== 'memory'" size="tiny" quaternary @click="startEdit('memory')">
                <template #icon>
          ...
          <div class="memory-section">
            <div class="section-header">
              ...
              <NButton v-if="canEditMemory && editingSection !== 'user'" size="tiny" quaternary @click="startEdit('user')">
                <template #icon>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
          ...
          <div class="memory-section">
            <div class="section-header">
              ...
              <NButton v-if="canEditMemory && editingSection !== 'soul'" size="tiny" quaternary @click="startEdit('soul')">
                <template #icon>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
