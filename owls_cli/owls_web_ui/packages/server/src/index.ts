...
import { setupTerminalWebSocket } from './routes/owls/terminal'
...
export async function bootstrap() {
  console.log(`owls-web-ui v${APP_VERSION} starting...`)
  ...
  const { initUsageStore } = await import('./db/owls/usage-store')
  initUsageStore()
  ...
  server.on('listening', () => {
    ...
    console.log(`Log: ~/.owls-web-ui/logs/server.log`)
