...
Usage:
    owls pairing list              # Show all pending + approved users
    owls pairing approve <platform> <code>  # Approve a pairing code
    owls pairing revoke <platform> <user_id> # Revoke user access
    owls pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle owls pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: owls pairing {list|approve|revoke|clear-pending}")
        print("Run 'owls pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'owls pairing list' to see pending codes.\n")
