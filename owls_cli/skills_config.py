"""
Skills configuration for OWLS.
`owls skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.owls/config.yaml under:
...
from owls_cli.platforms import PLATFORMS as _PLATFORMS
