"""OWLS CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.owls/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "OWLS"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ OWLS "       # Response box header label
...
.. code-block:: python
    ...
    from owls_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "OWLS"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.owls/skins/
...
Drop a YAML file in ``~/.owls/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces OWLS_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces OWLS_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Linux green terminal theme — minimal and focused",
        "colors": {
            "banner_border": "#00C94F",
            "banner_title": "#00FF66",
            "banner_accent": "#00FF66",
            "banner_dim": "#00A63F",
            "banner_text": "#C7FFD1",
            "ui_accent": "#00FF66",
            "ui_label": "#7DFF9B",
            ...
            "prompt": "#C7FFD1",
            "input_rule": "#00C94F",
            "response_border": "#00FF66",
            "session_label": "#7DFF9B",
            "session_border": "#00A63F",
        },
        "spinner": {
            "waiting_faces": ["🦉💭"],
            "thinking_faces": ["🦉💭"],
        ...
        "branding": {
            "agent_name": "OWLS",
            "welcome": "Welcome to OWLS.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " >_ OWLS ",
            "prompt_symbol": "> ",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "branding": {
            "agent_name": "OWLS",
            "welcome": "Welcome to OWLS! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ OWLS ",
            "prompt_symbol": "❯ ",
            "help_header": "[?] Available Commands",
