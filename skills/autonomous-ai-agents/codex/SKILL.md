...
metadata:
  owls:
    ...
    related_skills: [claude-code, owls]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the OWLS terminal. Codex is OpenAI's autonomous coding agent CLI.
