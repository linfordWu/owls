...
Built for [OWLS](https://github.com/NousResearch/owls). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/owls/skills/creative/ascii-video`](https://github.com/NousResearch/owls/tree/main/skills/creative/ascii-video) via PR.
