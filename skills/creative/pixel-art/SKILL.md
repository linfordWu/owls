...
```python
import sys
sys.path.insert(0, "/home/teknium/.owls/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.owls/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — OWLS installs package this)
