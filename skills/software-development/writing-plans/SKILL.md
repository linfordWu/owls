...
version: 1.1.0
author: OWLS (adapted from obra/superpowers)
license: MIT
metadata:
  owls:
...
> **For OWLS:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use OWLS tools to understand the project:
