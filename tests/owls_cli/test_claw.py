...
from owls_cli import claw as claw_mod
...
class TestFindMigrationScript:
    ...
    def test_finds_project_root_script(self, tmp_path):
        script = tmp_path / "openclaw_to_owls.py"
...
class TestCmdMigrate:
    ...
    def test_dry_run_succeeds(self, tmp_path, capsys):
        ...
        fake_mod = ModuleType("openclaw_to_owls")
...
class TestPrintMigrationReport:
    ...
    def test_dry_run_report(self, capsys):
        report = {
            ...
            "items": [
                {"kind": "soul", "status": "migrated", "destination": "/home/user/.owls/SOUL.md"},
                {"kind": "memory", "status": "migrated", "destination": "/home/user/.owls/memories/MEMORY.md"},
    ...
    def test_execute_report(self, capsys):
        report = {
            ...
            "output_dir": "/home/user/.owls/migration/openclaw/20250312T120000",
        }
