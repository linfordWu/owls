"""Tests for the interactive session browser (`owls sessions browse`).
...
from owls_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """owls sessions browse should be parseable."""
        from owls_cli.main import main as _main_entry
