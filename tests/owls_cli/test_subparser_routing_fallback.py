...
The main() function in owls_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `owls -c model`
...
def _build_parser():
    """Build a minimal replica of the owls top-level parser."""
