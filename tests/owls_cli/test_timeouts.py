...
def test_resolved_api_call_timeout_priority(monkeypatch, tmp_path):
          ...
          openrouter:
            ...
            models:
              openai/gpt-4o-mini:
                timeout_seconds: 42
        """)
    monkeypatch.setenv("OWLS_API_TIMEOUT", "999")
    ...
    import importlib
    from owls_cli import config as cfg_mod
    importlib.reload(cfg_mod)
    from owls_cli import timeouts as to_mod
    ...
    monkeypatch.delenv("OWLS_API_TIMEOUT", raising=False)
