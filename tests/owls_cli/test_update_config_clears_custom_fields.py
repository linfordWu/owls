"""Tests for owls_cli.auth._update_config_for_provider clearing stale fields.
...
from owls_cli.auth import _update_config_for_provider
from owls_cli.config import get_config_path
