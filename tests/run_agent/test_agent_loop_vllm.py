"""Integration tests for OWLSLoop with a local vLLM server.
...
try:
    from environments.agent_loop import AgentResult, OWLSLoop
except ImportError:
...
def _make_server_manager():
    ...
    sm = ServerManager([config], tool_parser="owls")
