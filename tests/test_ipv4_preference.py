...
def _reload_constants():
    """Reload owls_constants to get a fresh apply_ipv4_preference."""
    import owls_constants
    importlib.reload(owls_constants)
    return owls_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_owls_ipv4_patched", False) is True
