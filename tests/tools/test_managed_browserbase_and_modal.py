...
def _enable_managed_nous_tools(monkeypatch):
    ...
    owls_cli.auth and owls_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("owls_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("owls_cli.models.check_nous_free_tier", lambda: False)
