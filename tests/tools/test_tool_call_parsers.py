...
class TestParserRegistry:
    ...
    def test_owls_parser_registered(self):
        parsers = list_parsers()
        assert "owls" in parsers
...
class TestOWLSParser:
    @pytest.fixture
    def parser(self):
        return get_parser("owls")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["owls"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use owls format since that's universal
