...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_owls_home_override(self, tmp_path):
        """Auth lookup should read from OWLS_HOME/auth.json, not ~/.owls/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".owls").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``owls tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
