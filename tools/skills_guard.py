...
Trust levels:
  - builtin:   Ships with OWLS. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.owls/\.env|\~/\.owls/\.env',
     "owls_env_access", "critical", "exfiltration",
     "directly references OWLS secrets file"),
    ...
    (r'\.owls/config\.yaml|\.owls/SOUL\.md',
     "owls_config_mod", "critical", "persistence",
     "references OWLS configuration files directly"),
