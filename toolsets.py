...
_OWLS_CORE_TOOLS = [
    ...
    # Cronjob management
    "cronjob",
    # AgentTeams coordination (available only when --teammate-mode is enabled)
    "agent_team",
]
...
TOOLSETS = {
    ...
    "agent_team": {
        "description": "Coordinate AgentTeams roles when teammate mode is enabled",
        "tools": ["agent_team"],
        "includes": []
    },
    ...
    # Full OWLS toolsets retained for Linux CLI and web API server.
